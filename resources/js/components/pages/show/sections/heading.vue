<template>
  <div
    ...
    :class="heading.sectionClass"
    :id="heading.sectionId"
    v-bind:style="sectionStyle"
    v-if="Object.entries(heading).length != 0"
  >
    <div class="container" v-if="heading.link">
      <h1
        v-if="this.heading.tag == 'h1'"
        v-bind:class="[isActive ? 'activeClass' : '', heading.elementClass]"
      ...
      >
        ...
        >{{this.heading.title}}</a>
      </h1>
      <h2
        v-else-if="this.heading.tag == 'h2'"
        v-bind:class="[isActive ? 'activeClass' : '', heading.elementClass]"
        :id="heading.elementId"
      >
        <a
    ...
    <div class="container" v-else>
      <h1
        v-if="this.heading.tag == 'h1'"
        v-bind:style="headingStyle"
        v-bind:class="[isActive ? 'activeClass' : '', heading.elementClass]"
        :id="heading.elementId"
      >{{this.heading.title}}</h1>
      <h2
        v-else-if="this.heading.tag == 'h2'"
        v-bind:style="headingStyle"
        v-bind:class="[isActive ? 'activeClass' : '', heading.elementClass]"
        :id="heading.elementId"
      >{{this.heading.title}}</h2>
      <h3
        v-else-if="this.heading.tag == 'h3'"
        v-bind:style="headingStyle"
        v-bind:class="[isActive ? 'activeClass' : '', heading.elementClass]"
      ...
      <h4
        ...
        v-bind:class="[isActive ? 'activeClass' : '', heading.elementClass]"
        :id="heading.elementId"
      >{{this.heading.title}}</h4>
      <h5
        v-else-if="this.heading.tag == 'h5'"
        v-bind:style="headingStyle"
        v-bind:class="[isActive ? 'activeClass' : '', heading.elementClass]"
        :id="heading.elementId"
      >{{this.heading.title}}</h5>
      <h6
        v-else-if="this.heading.tag == 'h6'"
        v-bind:style="headingStyle"
        v-bind:class="[isActive ? 'activeClass' : '', heading.elementClass]"
        :id="heading.elementId"
      >{{this.heading.title}}</h6>
    </div>
  </div>
</template>
<script>
