          ...
          <ul class="page_logo_preview">
            <li id="pageLogoID" v-if="form.headerStyling.logo">
              ...
              <label for="radio1">
                <span>
                  <img
                    :src="baseURL+'/uploads/pages/'+pageID+'/'+form.headerStyling.logo"
                    v-if="pageID"
                  />
      ...
      setTimeout(function() {
        if (
          document.querySelector(
            "#page_logo_wrapper .at-profile-setting__imgs ul li input[type=hidden]"
          )
        ) {
          var hidddenIcon = document.querySelector(
            "#page_logo_wrapper .at-profile-setting__imgs ul li input[type=hidden]"
          );
