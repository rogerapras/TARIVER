<?php $__env->startSection('title'); ?><?php echo e($job->title); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(file_exists(resource_path('views/extend/front-end/includes/inner-banner.blade.php'))): ?>
        <?php echo $__env->make('extend.front-end.includes.inner-banner', 
            ['title' => trans('lang.job_detail'), 'inner_banner' => '', 'show_banner' => 'true' ]
                        ...
                        <?php if(!empty($job)): ?>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8 float-left">
                                <div class="wt-projectdetail-holder">
                                    ...
                                    <?php endif; ?>
                                    <?php if(!empty($attachments) && $job->show_attachments === 'true' && !empty($job->employer)): ?>
