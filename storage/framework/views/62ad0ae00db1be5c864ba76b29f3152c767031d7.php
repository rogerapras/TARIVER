													...
													<div class="wt-contenthead">
														...
														<?php if(!empty($job->price) ||
															...
															<ul class="wt-saveitem-breadcrumb wt-userlisting-breadcrumb">
																...
																<li><a href="javascript:void(0);" class="wt-clicksavefolder"><img class="wt-job-icon" src="<?php echo e(asset('images/job-icons/job-type.png')); ?>"> <?php echo e(trans('lang.type')); ?> <?php echo e($project_type); ?></a></li>
																<?php endif; ?>
																<?php if(!empty($job->duration)): ?>
																	<li><span class="wt-dashboradclock"><img class="wt-job-icon" src="<?php echo e(asset('images/job-icons/job-duration.png')); ?>"> <?php echo e(trans('lang.duration')); ?> <?php echo e($duration); ?></span></li>
																<?php endif; ?>
															</ul>
														<?php endif; ?>
													</div>
