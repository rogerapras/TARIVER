            ...
            <div class=" col-sm-12 col-md-12 col-lg-10 push-lg-1 col-xl-8 push-xl-2" id="packages">
                ...
                <div class="sj-checkoutjournal">
                    ...
                    <?php
                        ...
                        session()->put(['product_price' => (e($service->price) * 1.02)]);
                        ...
                        <thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo e(!empty($symbol['symbol']) ? $symbol['symbol'] : '$'); ?><?php echo e($service->price); ?> </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(!empty($symbol['symbol']) ? $symbol['symbol'] : '$'); ?><?php echo e((e($service->price)*1.02)); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <form class="wt-formtheme wt-form-paycard" method="POST" id="stripe-payment-form" role="form" action="" @submit.prevent='submitStripeFrom'>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group wt-btnarea">
                                    <input type="submit" name="button" class="wt-btn" value="Pay <?php echo e(!empty($symbol['symbol']) ? $symbol['symbol'] : '$'); ?><?php echo e($service->price); ?>">
                                </div>
                            </fieldset>
                        </form>
                    </div>
