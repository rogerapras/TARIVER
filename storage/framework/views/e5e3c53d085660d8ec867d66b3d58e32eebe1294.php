    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 float-left" id="services">
            ...
            <div class="wt-haslayout wt-post-job-wrap">
                <?php echo Form::open(['url' => '', 'class' =>'wt-haslayout', 'id' => 'post_service_form',  '@submit.prevent'=>'submitService']); ?>

                    <div class="wt-dashboardbox">
                        <div class="wt-dashboardboxtitle">
                            <h2><?php echo e(trans('lang.post_service')); ?></h2>
                        </div>
                        <div class="wt-dashboardboxcontent">
                            <div class="wt-jobdescription wt-tabsinfo">
                                <div class="wt-tabscontenttitle">
                                    <h2><?php echo e(trans('lang.service_desc')); ?></h2>
                                </div>
                                <div class="wt-formtheme wt-userform wt-userformvtwo">
                                    <fieldset>
                                        <div class="form-group">
                                            <input type="text" name="title" class="form-control" placeholder="<?php echo e(trans('lang.service_title')); ?>" v-model="title">
                                        </div>
                                        <div class="form-group form-group-half wt-formwithlabel">
                                            <span class="wt-select">
                                                <?php echo Form::select('delivery_time', $delivery_time, null, array('class' => '', 'placeholder' => trans('lang.select_delivery_time'), 'v-model'=>'delivery_time')); ?>

                                            </span>
                                        </div>
                                        <div class="form-group form-group-half wt-formwithlabel job-cost-input">
                                            <?php echo Form::number('service_price', null, array('class' => '', 'placeholder' => trans('lang.service_price'), 'v-model'=>'price')); ?>
                            ...
                            <div class="wt-jobcategories wt-tabsinfo">
                                <div class="wt-tabscontenttitle">
                                    <h2><?php echo e(trans('lang.service_cats')); ?></h2>
                                </div>
                                <div class="wt-divtheme wt-userform wt-userformvtwo">
                                    <div class="form-group">
                                        <span class="wt-select">
                                            <?php echo Form::select('categories[]', $categories, null, array('class' => 'chosen-select', 'multiple', 'data-placeholder' => trans('lang.select_service_cats'))); ?>
                            ...
                            <div class="wt-languages-holder wt-tabsinfo">
                                <div class="wt-tabscontenttitle">
                                    <h2><?php echo e(trans('lang.service_response_time')); ?></h2>
                                </div>
                                <div class="wt-divtheme wt-userform wt-userformvtwo">
                                    <div class="form-group">
                                        <span class="wt-select">
                                            <?php echo Form::select('response_time', $response_time, null, array('class' => '', 'placeholder' => trans('lang.select_response_time'), 'v-model'=>'response_time')); ?>
                            ...
                            <div class="wt-jobdetails wt-tabsinfo">
                                ...
                                <div class="wt-formtheme wt-userform wt-userformvtwo">
                                    <?php echo Form::textarea('description', null, ['class' => 'wt-tinymceeditor', 'id' => 'wt-tinymceeditor', 'placeholder' => trans('lang.service_desc_note')]); ?>
                            ...
                            <div class="wt-attachmentsholder">
                                <div class="lara-attachment-files">
                                    ...
                                    <image-attachments :temp_url="'<?php echo e(url('service/upload-temp-image')); ?>'" :type="'image'"></image-attachments>
                    ...
                    <div class="wt-updatall">
                        ...
                        <?php echo Form::submit(trans('lang.post_service'), ['class' => 'wt-btn', 'id'=>'submit-service']); ?>
