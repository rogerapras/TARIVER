<?php echo Form::open(['url' => '', 'class' =>'wt-formtheme wt-userform', 'id' =>'comission-form', '@submit.prevent'=>'submitCommisionSettings']); ?>
    ...
    <?php endif; ?>
    <?php if(file_exists(resource_path('views/extend/back-end/admin/settings/payment/payment-mode.blade.php'))): ?>
        <?php echo $__env->make('extend.back-end.admin.settings.payment.payment-mode', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php else: ?>
        <?php echo $__env->make('back-end.admin.settings.payment.payment-mode', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php endif; ?>
    ...
    <div class="wt-location wt-tabsinfo">
        <div class="wt-tabscontenttitle">
            <h2><?php echo e(trans('lang.commission_settings_freelancer')); ?></h2>
        </div>
        <div class="wt-settingscontent">
    ...
    <div class="wt-location wt-tabsinfo">
        <div class="wt-tabscontenttitle">
            <h2><?php echo e(trans('lang.commission_settings_employer')); ?></h2>
        </div>
        <div class="wt-settingscontent">
            <div class="wt-description">
                <p><?php echo e(trans('lang.set_comm_project')); ?></p>
            ...
            <div class="wt-formtheme wt-userform">
                <div class="form-group">
                    <?php echo Form::number('payment[0][commision_em]', $commision_em, array('class' => 'form-control', 'placeholder' => '0')); ?>
