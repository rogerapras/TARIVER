                                                    ...
                                                    <div class="wt-viewjobholder">
                                                        <ul>
                                                            <?php if(!empty($job->project_level)): ?>
                                                                <li>
                                                                    <span>
                                                                        <img class="wt-job-icon" src="<?php echo e(asset('images/job-icons/job-level.png')); ?>">
                                                                        <?php echo e(Helper::getProjectLevel($job->project_level)); ?>
                                                            ...
                                                            <?php if(!empty($job->location->title)): ?>
                                                                <li><span><img src="<?php echo e(asset(Helper::getLocationFlag($job->location->flag))); ?>" alt="<?php echo e(trans('lang.location')); ?>"> <?php echo e($job->location->title); ?></span></li>
                                                            <?php endif; ?>
                                                            <li><span><img class="wt-job-icon" src="<?php echo e(asset('images/job-icons/job-type.png')); ?>"><?php echo e(trans('lang.type')); ?> <?php echo e($project_type); ?></span></li>
                                                            <li><span><img class="wt-job-icon" src="<?php echo e(asset('images/job-icons/job-duration.png')); ?>"><?php echo e(Helper::getJobDurationList($job->duration)); ?></span></li>
                                                            <li><span><i class="fa fa-tag wt-viewjobtag"></i><?php echo e(trans('lang.job_id')); ?> <?php echo e($job->code); ?></span></li>
                                                            <?php if(!empty($user->profile->saved_jobs) && in_array($job->id, unserialize($user->profile->saved_jobs))): ?>
                                                                <li style=pointer-events:none;>                
                                                                    <span>
                                                                        <a href="javascript:;" class="wt-clicklike wt-clicksave">
                                                                            <img class="wt-job-icon" src="<?php echo e(asset('images/job-icons/favorite.png')); ?>"  alt="Project Level">
                                                                            <em><?php echo e(trans("lang.saved")); ?></em>
                                                                        </a>
                                                                    </span>                           
                                                                </li>
                                                            <?php else: ?>
                                                                <li>                
                                                                    <span>
                                                                        <a href="javascript:;" class="wt-clicklike wt-add-to-saved_projects" id="job-<?php echo e($job->id); ?>" @click.prevent="add_wishlist('job-<?php echo e($job->id); ?>', <?php echo e($job->id); ?>, 'saved_jobs', '<?php echo e(trans("lang.saved")); ?>')">
                                                                            <img class="wt-job-icon" src="<?php echo e(asset('images/job-icons/favorite.png')); ?>" alt="Project Level">
                                                                            <em class="save_text"><?php echo e(trans('lang.save')); ?></em>
                                                                        </a>
                                                                    </span>               
                                                                </li>
                                                            <?php endif; ?>
