<?php echo Form::open(['url' => '', 'class' =>'wt-formtheme wt-userform', 'id' =>'menu-setting-form', '@submit.prevent'=>'submitMenuSettings']); ?>

    <div class="wt-securitysettings wt-tabsinfo wt-haslayout">
        <div class="wt-tabscontenttitle">
                <h2><?php echo e(trans('lang.color_settings')); ?></h2>
        </div>
        ...
        <div class="wt-tabscontenttitle">
            <h2><?php echo e(trans('lang.pages_order')); ?></h2>
        </div>
