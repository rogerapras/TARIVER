        ...
        <div id="wt-verticalscrollbar" class="wt-verticalscrollbar">
            <div class="wt-companysdetails wt-usersidebar">
                ...
                <div class="wt-companysinfo">
                    <figure><img src="<?php echo e(asset(Helper::getImageWithSize('uploads/users/'.$user->id, $profile->avater, 'listing'))); ?>" alt="<?php echo e(trans('lang.profile_photo')); ?>"></figure>
                    <div class="wt-title">
                        <h2>
                ...
                <ul>
                    <?php if($role === 'admin'): ?>
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li><hr><a href="<?php echo e(route('articles')); ?>"><?php echo e(trans('lang.articles')); ?></a></li>
                                <li><hr><a href="<?php echo e(route('articleCategories')); ?>"><?php echo e(trans('lang.categories')); ?></a></li>
                            </ul>
                        </li>
                        <li>
