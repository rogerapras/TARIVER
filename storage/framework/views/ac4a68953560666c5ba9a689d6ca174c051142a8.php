                                                ...
                                                <div class="wt-userlistinghold wt-proposalitem <?php echo e($feature_class); ?>">
                                                    ...
                                                    <div class="wt-rightarea">
                                                        <div class="wt-btnarea">
                                                            <?php if(empty($accepted_proposal)): ?>
                                                                <?php if(!empty($order)): ?>
                                                                   <?php if($order->product_id == $proposal->id): ?>     
                                                                        <h5><?php echo e(trans('lang.pending_hiring')); ?></h5>
                                                                   <?php endif; ?>
                                                                <?php else: ?>
                                                                    <a href="javascript:void(0);"  v-on:click.prevent="hireFreelancer('<?php echo e($proposal->id); ?>', '<?php echo e($mode); ?>')" class="wt-btn"><?php echo e(trans('lang.hire_now')); ?></a>
                                                                <?php endif; ?>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div class="wt-hireduserstatus">
