                ...
                <div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
                    <div class="wt-dashboardtabs">
                        <ul class="wt-tabstitle nav navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="<?php echo e(\Request::route()->getName()==='settings/#wt-homepage'? 'active': ''); ?>" data-toggle="tab" href="#wt-homepage"><?php echo e(trans('lang.homepage_settings')); ?></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="<?php echo e(\Request::route()->getName()==='settings/#wt-project-settings'? 'active': ''); ?>" data-toggle="tab" href="#wt-project-settings"><?php echo e(trans('lang.project_settings')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="<?php echo e(\Request::route()->getName()==='settings/#wt-bank-account-settings'? 'active': ''); ?>" data-toggle="tab" href="#wt-bank-account-settings"><?php echo e(trans('lang.bank_detail')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="<?php echo e(\Request::route()->getName()==='settings/#wt-offline-order-settings'? 'active': ''); ?>" data-toggle="tab" href="#wt-offline-order-settings"><?php echo e(trans('lang.offline_order_settings')); ?></a>
                            </li>
                            <li class="nav-item menu-setting-item" v-on:click="displayMenuSettings">
                                <a class="<?php echo e(\Request::route()->getName()==='settings/#wt-menu-settings'? 'active': ''); ?>" data-toggle="tab" href="#wt-menu-settings"><?php echo e(trans('lang.menu_settings')); ?></a>
                            </li>
                        </ul>
                    </div>
                    <div class="wt-tabscontent tab-content">
                        ...
                        <div class="wt-securityhold tab-pane la-general-setting" id="wt-homepage">
                            <?php if(file_exists(resource_path('views/extend/back-end/admin/settings/homepage/index.blade.php'))): ?>
                                <?php echo $__env->make('extend.back-end.admin.settings.homepage.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('back-end.admin.settings.homepage.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="wt-securityhold tab-pane la-footer-setting" id="wt-project-settings">
                            <?php if(file_exists(resource_path('views/extend/back-end/admin/settings/project-settings/index.blade.php'))): ?>
                                <?php echo $__env->make('extend.back-end.admin.settings.project-settings.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('back-end.admin.settings.project-settings.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php endif; ?>
                        </div>
                        <div class="wt-securityhold tab-pane la-footer-setting" id="wt-bank-account-settings">
                            <?php if(file_exists(resource_path('views/extend/back-end/admin/settings/bank-account/index.blade.php'))): ?>
                                <?php echo $__env->make('extend.back-end.admin.settings.bank-account.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('back-end.admin.settings.bank-account.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php endif; ?>
                        </div>
                        <div class="wt-securityhold tab-pane la-footer-setting" id="wt-offline-order-settings">
                            <?php if(file_exists(resource_path('views/extend/back-end/admin/settings/offline-order/index.blade.php'))): ?>
                                <?php echo $__env->make('extend.back-end.admin.settings.offline-order.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('back-end.admin.settings.offline-order.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php endif; ?>
                        </div>
                        <div class="wt-securityhold tab-pane la-menu-setting" id="wt-menu-settings">
                            <?php if(file_exists(resource_path('views/extend/back-end/admin/settings/menu/index.blade.php'))): ?>
                                <?php echo $__env->make('extend.back-end.admin.settings.menu.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('back-end.admin.settings.menu.index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
