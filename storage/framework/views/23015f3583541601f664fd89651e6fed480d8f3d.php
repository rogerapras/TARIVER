        ...
        <div class="wt-formtheme wt-userform">
            <div v-if="this.service_logo">
                <upload-image
                    ...
                    :url="'<?php echo e(url('admin/upload-temp-image/service_logo')); ?>'"
                    :name="'service_logo'"
            ...
            <div class="wt-uploadingbox" v-else>
                ...
                <div class="wt-uploadingbar">
                    ...
                    <em><?php echo e(trans('lang.file_size')); ?><a href="javascript:void(0);" class="lnr lnr-cross" v-on:click.prevent="removeImage('hidden_service_logo')"></a></em>
                </div>
            </div>
            <input type="hidden" name="inner_page[0][service_logo]" id="hidden_service_logo" value="<?php echo e($service_logo); ?>">
        </div>
    <?php else: ?>
        <div class="wt-formtheme wt-userform">
            <upload-image
