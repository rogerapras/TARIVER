<div class="wt-tabscontenttitle">
    ...
    <?php echo Form::open(['url' => '', 'class' =>'wt-formtheme wt-userform', 'id'
        ...
        <?php endif; ?>
        <?php if(file_exists(resource_path('views/extend/back-end/admin/settings/footer/background.blade.php'))): ?>
            <?php echo $__env->make('extend.back-end.admin.settings.footer.background', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('back-end.admin.settings.footer.background', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
        <div class="wt-location wt-tabsinfo">
            <div class="wt-tabscontenttitle">
                <h2><?php echo e(trans('lang.footer_style')); ?></h2>
            </div>
                ...
                <div class="amt-section-select amt-profile-settings">
                    <ul class="at-profile-setting__imgs">
                        ...
                        <input 
                            ...
                            :checked="style.value == '<?php echo e($selected_footer); ?>'"  
                            :value="style.value"
                        >
