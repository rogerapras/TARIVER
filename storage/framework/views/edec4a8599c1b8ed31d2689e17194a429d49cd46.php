            ...
            <div class=" col-sm-12 col-md-8 push-md-2 col-lg-8 push-lg-2" id="packages">
                ...
                <div class="sj-checkoutjournal">
                    ...
                    <?php
                        ...
                        session()->put(['product_price' => (e($proposal->amount))*(100 + $commision_em) / 100]);
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(!empty($symbol['symbol']) ? $symbol['symbol'] : '$'); ?><?php echo e((e($proposal->amount))*(100 + $commision_em) / 100); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
