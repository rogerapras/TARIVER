		...
		<div id="wt-demo-sidebar" class="wt-demo-sidebar">
			...
			<div id="wt-verticalscrollbar" class="wt-verticalscrollbar">
				<div class="wt-demo-holder">
					<a href="<?php echo e(url('page/home-page-four')); ?>">
						<figure class="wt-demo-img">
							<img src="<?php echo e(url('images/demo-img/img-06.jpg')); ?>" alt="img">
							<figcaption>
					...
					<a href="<?php echo e(url('page/home-page-five')); ?>">
						<figure class="wt-demo-img">
							<img src="<?php echo e(url('images/demo-img/img-07.jpg')); ?>" alt="img">
							<figcaption>
								<div class="wt-demo-tags">
									<span class="wt-demo-new">New</span>
								</div>
