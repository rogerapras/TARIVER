<div class="wt-settingscontent">
    <?php if(!empty($article_inner_banner)): ?>
        <?php
        ...
        <div class="wt-formtheme wt-userform">
            <div v-if="this.article_inner_banner">
                <upload-image
                    ...
                    :url="'<?php echo e(url('admin/upload-temp-image/article_inner_banner')); ?>'"
            ...
            <div class="wt-uploadingbox" v-else>
                ...
                <div class="wt-uploadingbar">
                    ...
                    <em><?php echo e(trans('lang.file_size')); ?><a href="javascript:void(0);" class="lnr lnr-cross" v-on:click.prevent="removeImage('hidden_article_inner_banner')"></a></em>
                </div>
            </div>
            <input type="hidden" name="inner_page[0][article_inner_banner]" id="hidden_article_inner_banner" value="<?php echo e($article_inner_banner); ?>">
        </div>
    <?php else: ?>
        <div class="wt-formtheme wt-userform">
            <upload-image
