...
class SiteManagementController extends Controller
{
    ...
    public function settings()
    {
        ...
        $commision_em = !empty($payout_settings[0]['commision_em']) ? $payout_settings[0]['commision_em'] : null;
        ...
        if (file_exists(resource_path('views/extend/back-end/admin/settings/index.blade.php'))) {
            return view(
                ...
                compact(
                    ...
                    'new_order_subject',
                    'new_order_content',
                    'employer_hiring_subject',
                    'employer_hiring_content',
                    'bank_bic_swift',
                    'bank_iban',
                    'bank_description',
                    'bank_instruction',
